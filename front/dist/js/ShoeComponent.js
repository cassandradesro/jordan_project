...
var ShoeComponent = Vue.component("shoe", {
	...
	mounted: function mounted() {
		...
		axios //172.31.16.162
		.get("http://localhost:4792/shoe/" + this.$route.params.id).then(function (res) {
	...
	methods: {
		sendMessage: function sendMessage() {
			...
			axios //172.31.16.162
			.post("http://localhost:4792/shoe/" + this.$route.params.id + "/message", {
